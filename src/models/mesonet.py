...
class Meso4(nn.Module):
    ...
    def __init__(self, num_classes=1, **kwargs):
        ...
        fc1_dim = kwargs.get("fc1_dim", 16*7*7)
        input_channels = kwargs.get("input_channels", 3)
        self.num_classes = num_classes

        self.conv1 = nn.Conv2d(input_channels, 8, 3, padding=1, bias=False)
...
if __name__ == "__main__":
    model = MesoInception4(fc1_dim=384, input_channels=4)
    x = torch.rand((12,4,80,404))
    output = model(x)
    print(output)
